...
function initMap() {
    ...
    var mapOptions = {
        ...
        minZoom: 4,
        zoomControl: false,
        keyboardShortcuts: true // Add this line to enable keyboard shortcuts
    };
...
// Add event listener to update map zoom level when slider value changes
zoomSlider.addEventListener('input', function() {
    var zoomLevel = parseInt(this.value);
    map.setZoom(zoomLevel);
});

// Add event listener to handle continuous zooming when slider is held
var isSliding = false;
...
zoomSlider.addEventListener('mousemove', function() {
    if (isSliding) {
        handleSliderChange();
    }
});
